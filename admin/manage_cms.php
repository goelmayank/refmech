...
$sql="select * from pagetable where deleteflag='n' and (parentid IS NULL or parentid=0) order by pageid" ;
...
<div id="header">
	<div class="shell">
		<!-- Logo + Top Nav -->
		<div id="top">
			<h1><a href="#">Dashboard-Manage CMS</a></h1>
			</div>
		<!-- End Logo + Top Nav -->
		</div>
</div>
		...
		<div id="main">
           ...
           $pagename = $row["pagename"];
		   	?>
                 ...
                 <?php
			$childsql="select * from pagetable where deleteflag='n' and parentid='$pageid'" ;
