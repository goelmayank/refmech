...
$sql="select * from tbl_course where status='n' and (course_type='DISTANCE') order by id" ;
		   ...
		   $course_type = $row["course_type"];
		   	?>
							<tr>
                                ...
                                <a class="ico edit" href="edit_distance_course.php?pid=<?php echo $pageid;?>" >Edit</a>
                 <?php
